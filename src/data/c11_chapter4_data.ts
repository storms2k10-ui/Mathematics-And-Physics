...
import { C11_CH4_NORMAL_PART1 } from './c11_ch4_normal_part1';
import { C11_CH4_NORMAL_PART2 } from './c11_ch4_normal_part2';
import { C11_CH4_NORMAL_PART3 } from './c11_ch4_normal_part3';
import { C11_CH4_NORMAL_PART4 } from './c11_ch4_normal_part4';
...
export const C11_CH4_NORMAL_QUESTIONS: Question[] = [
  ...C11_CH4_NORMAL_PART1,
  ...C11_CH4_NORMAL_PART2,
  ...C11_CH4_NORMAL_PART3,
  ...C11_CH4_NORMAL_PART4,
];
