...
export const C11_CH7_ADVANCED_PART1: Question[] = [
  ...
  },
  {
    ...
    "correct_answer": "B",
    "explanation": "The proof begins by checking that the statement holds at the initial value, usually (n=1).",
    "difficulty": "Hard",
    "difficulty_tier": "Advanced",
    "formula": "P(1) \\text{ is true} \\;\\land\\; [P(k) \\implies P(k+1)] \\implies P(n) \\text{ holds } \\forall n \\in \\mathbb{N}"
  },
  {
    ...
    "subject": "Mathematics",
    "chapter_id": "c11-ch7",
    "question": "The assumption that (P(k)) is true is called:",
    "options": {
      "A": "Conclusion",
      "B": "Base case",
  ...
  },
  {
    ...
    "subject": "Mathematics",
    "chapter_id": "c11-ch7",
    "question": "If (P(1)) is true and (P(k)Rightarrow P(k+1)), then:",
    "options": {
  ...
  },
  {
    ...
    "subject": "Mathematics",
    "chapter_id": "c11-ch7",
    "question": "For (1+2+cdots+n=\frac{n(n+1)}2), the base case (n=1) gives:",
    "options": {
      "A": "(1=0)",
      "B": "(1=1)",
      "C": "(1=2)",
  ...
  },
  {
    ...
    "difficulty": "Hard",
    "difficulty_tier": "Advanced",
    "formula": "1^3 + 2^3 + \\dots + n^3 = \\left[\\frac{n(n+1)}{2}\\right]^2"
  },
  {
    "id": "c11-ch7-adv-q17",
    "class": 11,
  ...
  },
  {
    ...
    "subject": "Mathematics",
    "chapter_id": "c11-ch7",
    "question": "To prove (3mid(2^{2n}-1)), the base case (n=1) gives:",
    "options": {
      "A": "(2^2-1=3)",
      "B": "(2-1=1)",
      "C": "(4-1=2)",
  ...
  },
  {
    ...
    "options": {
      ...
      "B": "Induction assumes (P(k)) temporarily",
      "C": "Proving only (P(1)) proves every case",
      "D": "The inductive step proves (P(k+1))"
    },
    "correct_answer": "C",
  ...
  },
  {
    ...
    "subject": "Mathematics",
    "chapter_id": "c11-ch7",
    "question": "If an induction proof starts at (n=4), the required base case is:",
    "options": {
      "A": "(P(1))",
      "B": "(P(4))",
      "C": "(P(0))",
  ...
  },
  {
    ...
    "subject": "Mathematics",
    "chapter_id": "c11-ch7",
    "question": "If (P(5)) is true and (P(k)Rightarrow P(k+1)) for every (kge5), then (P(n)) is proved for:",
    "options": {
      "A": "All integers",
      "B": "(n<5) only",
