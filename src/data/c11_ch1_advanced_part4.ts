...
export const C11_CH1_ADVANCED_PART4: Question[] = [
  ...
  },
  {
    ...
    "difficulty": "Hard",
    "difficulty_tier": "Advanced",
    "formula": "$z_1 z_2 = \\frac{(z_1 + z_2)^2 - (z_1 - z_2)^2}{4}$"
  },
  {
    "id": "c11-ch1-adv-q158",
    "class": 11,
  ...
  },
  {
    ...
    "correct_answer": "C",
    "correct_option": "C",
    "explanation": "Let the quadratic equation be $x^2 - 6x + k = 0$. The roots are given as $\\alpha = 3 + 4i$ and $\\beta = 3 - 4i$.\nBy Vieta's formulas, for a quadratic equation $ax^2 + bx + c = 0$, the product of the roots is $\\dfrac{c}{a}$:\n$$k = \\alpha \\cdot \\beta = (3 + 4i)(3 - 4i)$$\nEvaluating this product of complex conjugates:\n$$k = 3^2 - (4i)^2 = 9 - 16(-1) = 9 + 16 = 25$$\nWe can also verify using the sum of roots: $\\alpha + \\beta = (3 + 4i) + (3 - 4i) = 6 = -(-6)$, which is consistent. Thus, $k = 25$, corresponding to Option C.",
    "difficulty": "Hard",
    "difficulty_tier": "Advanced",
    "formula": "$\\overline{z_1 z_2} = \\bar{z}_1 \\bar{z}_2$"
  },
  {
    ...
    "correct_answer": "D",
    "correct_option": "D",
    "explanation": "Let the roots of $x^2 + 4x + k = 0$ be $\\alpha$ and $\\beta$. According to Vieta's formulas:\n$$\\alpha + \\beta = -4$$\nWe are given that the roots differ by $6i$, so $\\alpha - \\beta = 6i$.\nSolving for $\\alpha$ and $\\beta$ by adding and subtracting:\n$$2\\alpha = -4 + 6i \\implies \\alpha = -2 + 3i$$\\n$$2\\beta = -4 - 6i \\implies \\beta = -2 - 3i$$\nNow, $k$ is the product of the roots $\\alpha\\beta$:\n$$k = (-2 + 3i)(-2 - 3i) = (-2)^2 - (3i)^2 = 4 - 9(-1) = 4 + 9 = 13$$\nTherefore, the value of $k$ is $13$, which corresponds to Option D.",
    "difficulty": "Hard",
    "difficulty_tier": "Advanced",
    "formula": "$\\alpha \\beta = \\frac{c}{a}$"
  },
  ...
  },
  {
    ...
    "correct_answer": "B",
    "correct_option": "B",
    "explanation": "Multiplying $z^2 - z + 1 = 0$ by $(z + 1)$ gives $(z + 1)(z^2 - z + 1) = z^3 + 1 = 0$, so $z^3 = -1$. Squaring both sides yields $z^6 = (z^3)^2 = (-1)^2 = 1$.",
    "difficulty": "Hard",
    "difficulty_tier": "Advanced",
    "formula": "$x = \\frac{-b \\pm \\sqrt{b^2 - 4ac}}{2a}$"
  },
  ...
  },
  {
    ...
    "correct_answer": "C",
    "correct_option": "C",
    "explanation": "The modulus of any complex number is non-negative: $|w| \\ge 0$, with $|w| = 0$ if and only if $w = 0$.\nApplying this to $w = z_1 + z_2$:\n$$|z_1 + z_2| = 0 \\iff z_1 + z_2 = 0$$\nSubtracting $z_2$ from both sides:\n$$z_1 = -z_2$$\nTherefore, if $|z_1 + z_2| = 0$, it strictly implies $z_1 = -z_2$. This corresponds to Option C.",
    "difficulty": "Hard",
    "difficulty_tier": "Advanced",
    "formula": "$|a + bi| = \\sqrt{a^2 + b^2}$"
  },
  {
    ...
    "difficulty": "Hard",
    "difficulty_tier": "Advanced",
    "formula": "$(z_1 - z_2)^2 = (z_1 + z_2)^2 - 4z_1 z_2$"
  },
  {
    "id": "c11-ch1-adv-q191",
    "class": 11,
  ...
  },
  {
    ...
    "difficulty": "Hard",
    "difficulty_tier": "Advanced",
    "formula": "$|z - z_1| = r_1 \\text{ and } |z - z_2| = r_2 \\implies \\text{Intersection of circles}$"
  },
  {
    "id": "c11-ch1-adv-q198",
    "class": 11,
  ...
  },
  {
    ...
    "difficulty": "Hard",
    "difficulty_tier": "Advanced",
    "formula": "$\\operatorname{Re}\\left(\\frac{z_1}{z_2}\\right) = 0 \\iff |z_1 - z_2|^2 = |z_1|^2 + |z_2|^2$"
  },
  {
    "id": "c11-ch1-adv-q200",
    "class": 11,
