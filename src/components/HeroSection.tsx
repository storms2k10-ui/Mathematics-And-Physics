...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  const tracks: {
    ...
    },
    {
      ...
      subtitle: 'Classes 9, 10, 11, 12',
      description: 'Foundational physics principles: kinematics, Newtonian mechanics, work & energy, gravitation, wave theory, and thermodynamics.',
      classes: [9, 10, 11, 12],
      icon: Atom,
      accentColor: 'cyan',
      ...
      features: ['Kinematics & Dynamics', 'Work, Energy & Power', 'Fluid Mechanics', 'Thermal Physics'],
    },
    {
      id: 'Advanced Physics',
