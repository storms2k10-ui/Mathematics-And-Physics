          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-5 shadow-xl space-y-4">
            ...
            {selectedFractal === 'sierpinski' && (
              <div className="space-y-3 text-xs leading-relaxed text-slate-600 dark:text-slate-300">
                ...
                <div className="p-2.5 rounded-xl bg-indigo-50 dark:bg-indigo-950/40 border border-indigo-200 dark:border-indigo-800/60 font-mono text-[11px] text-indigo-700 dark:text-indigo-300 space-y-1">
                  <div><strong>Hausdorff Dimension:</strong></div>
                  <div>D = log(3) / log(2) ≈ 1.58496</div>
                </div>
                <div className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 font-mono text-[11px] space-y-1">
                  <div><strong>Area as n → ∞:</strong> A_n → 0</div>
                  <div><strong>Perimeter as n → ∞:</strong> P_n → ∞</div>
                </div>
              </div>
            )}
            ...
            {selectedFractal === 'koch' && (
              <div className="space-y-3 text-xs leading-relaxed text-slate-600 dark:text-slate-300">
                ...
                <div className="p-2.5 rounded-xl bg-cyan-50 dark:bg-cyan-950/40 border border-cyan-200 dark:border-cyan-800/60 font-mono text-[11px] text-cyan-700 dark:text-cyan-300 space-y-1">
                  <div><strong>Hausdorff Dimension:</strong></div>
                  <div>D = log(4) / log(3) ≈ 1.26186</div>
                </div>
                <div className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 font-mono text-[11px] space-y-1">
                  <div><strong>Total Area:</strong> 8/5 · A_0</div>
                  <div><strong>Perimeter:</strong> 3s_0 · (4/3)^n → ∞</div>
                </div>
              </div>
            )}
            ...
            {selectedFractal === 'dragon' && (
              <div className="space-y-3 text-xs leading-relaxed text-slate-600 dark:text-slate-300">
                ...
                <div className="p-2.5 rounded-xl bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800/60 font-mono text-[11px] text-amber-700 dark:text-amber-300 space-y-1">
                  <div><strong>Boundary Dimension:</strong></div>
                  <div>dim_H(∂D) ≈ 1.523627</div>
                </div>
            ...
            {selectedFractal === 'pythagoras_tree' && (
              <div className="space-y-3 text-xs leading-relaxed text-slate-600 dark:text-slate-300">
                ...
                <div className="p-2.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800/60 font-mono text-[11px] text-emerald-700 dark:text-emerald-300 space-y-1">
                  <div><strong>Pythagorean Area Invariant:</strong></div>
                  <div>a² + b² = c² (Total square area per level is conserved)</div>
                </div>
              </div>
            )}
            ...
            {selectedFractal === 'barnsley_fern' && (
              <div className="space-y-3 text-xs leading-relaxed text-slate-600 dark:text-slate-300">
                ...
                <div className="p-2.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800/60 font-mono text-[11px] text-emerald-700 dark:text-emerald-300 space-y-1">
                  <div><strong>Affine Map:</strong> f(x,y) = A · [x, y]^T + [e, f]^T</div>
            ...
            {selectedFractal === 'carpet' && (
              <div className="space-y-3 text-xs leading-relaxed text-slate-600 dark:text-slate-300">
                ...
                <div className="p-2.5 rounded-xl bg-indigo-50 dark:bg-indigo-950/40 border border-indigo-200 dark:border-indigo-800/60 font-mono text-[11px] text-indigo-700 dark:text-indigo-300 space-y-1">
                  <div><strong>Hausdorff Dimension:</strong></div>
                  <div>D = log(8) / log(3) ≈ 1.89279</div>
                </div>
                <div className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 font-mono text-[11px]">
                  <strong>Lebesgue Measure (Area):</strong> 0
                </div>
              </div>
            )}
            ...
            {(selectedFractal === 'mandelbrot' || selectedFractal === 'julia') && (
              <div className="space-y-3 text-xs leading-relaxed text-slate-600 dark:text-slate-300">
                ...
                <div className="p-2.5 rounded-xl bg-purple-50 dark:bg-purple-950/40 border border-purple-200 dark:border-purple-800/60 font-mono text-[11px] text-purple-700 dark:text-purple-300 space-y-1">
                  <div><strong>Recurrence:</strong> z_(n+1) = z_n² + c</div>
                  <div><strong>Boundedness:</strong> |z_n| ≤ 2 for all n</div>
                </div>
                <p className="text-[11px] text-slate-500">
                  Mitsuhiro Shishikura proved the boundary ∂M has Hausdorff dimension exactly 2.
                </p>
              </div>
            )}
